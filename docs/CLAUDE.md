...
- **Logic Placement:** Push transformations upstream to BigQuery (Views) whenever possible to avoid Looker Studio latency.# LatAm Pulse: Project Context & Standards
